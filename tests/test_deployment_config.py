...
def deployment_settings(**overrides) -> Settings:
    values = {
        ...
        "jwt_algorithm": "HS256",
        "mfa_encryption_keys": "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8=",
        "integration_credential_encryption_keys": "ICEiIyQlJicoKSorLC0uLzAxMjM0NTY3ODk6Ozw9Pj8=",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"mfa_encryption_keys": "not-an-encryption-key"}, "exactly 32 bytes"),
        ({"mfa_challenge_expire_minutes": 16}, "MFA_CHALLENGE_EXPIRE_MINUTES"),
        ({"mfa_enrollment_expire_minutes": 1}, "MFA_ENROLLMENT_EXPIRE_MINUTES"),
        ({"mfa_max_attempts": 2}, "MFA_MAX_ATTEMPTS"),
        ({"integration_credential_encryption_keys": ""}, "INTEGRATION_CREDENTIAL_ENCRYPTION_KEYS"),
        ({"integration_credential_encryption_keys": "not-an-encryption-key"}, "exactly 32 bytes"),
        ({"integration_connection_timeout_seconds": 31}, "INTEGRATION_CONNECTION_TIMEOUT_SECONDS"),
        ({"integration_connection_max_response_bytes": 512}, "INTEGRATION_CONNECTION_MAX_RESPONSE_BYTES"),
